...
//    private final Ticker ticker = new Ticker(null, Parameters.DELAY_MILLISECONDS);
//
...
//        if (index < 0 || index >= ethernet.length)
//            throw new IncorrectUserIndexException("Incorrect index " + index + " for length " + ethernet.length);
